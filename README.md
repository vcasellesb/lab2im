...
To install the lab2im software, you should have `python>=3.8` installed on your machine, then run the following code:

````bash
git clone git@github.com:vcasellesb/lab2im.git
cd lab2im
pip install -e .
````
